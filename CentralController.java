...
public class CentralController {
    ...
    public CentralController(Home home) {
        if (home == null) throw new IllegalArgumentException("Home cannot be null.");
        this.home = home;
    }
    ...
    // More “real” optimization: dim lights + eco for energy consumers + reduce thermostat target if possible
    public void optimizeEnergy() {
        for (Room r : home.getRooms()) {
            for (SmartDevice d : r.getDevices()) {
                ...
                // 3) If it's a Thermostat => you can reduce target if your Thermostat has a method for it
